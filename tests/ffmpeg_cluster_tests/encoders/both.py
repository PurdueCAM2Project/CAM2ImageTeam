...
DIR = 'CAM2ImageTeam/ffmpeg_cluster_tests/images_saves'

commandStr = 'ffmpeg -i ' + SRC_URL + ' -t ' + str(SECONDS_OF_FRAMES) + ' -f image2pipe -vcodec rawvideo -pix_fmt rgb24 - -vcodec png ' + DIR + 'both/frame%0d.png'
